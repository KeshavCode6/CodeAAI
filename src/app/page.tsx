  ...
  return (
    <Navbar path="/" loginOpen={loggedIn}>
      ...
      <div className="bg-darkBlue py-16 pb-32 sawtooth2 flex justify-center items-center">
        <ScrollableSection className=" flex flex-col md:flex-row justify-center items-center gap-4 2xl:gap-20">

          <div className="flex flex-col px-4 md:w-1/3 gap-5">
      ...
      <div className="bg-lightBlue overflow-y-hidden">
        <ScrollableSection className="relative h-[60vh] py-32">
          <div
            className='absolute top-0 left-0 right-0 bottom-0 bg-no-repeat bg-cover flex justify-center items-center'
            style={{ backgroundImage: "url('/assets/b3.svg')" }}
          >
            <div className="flex flex-col text-center">
              <span className="text-4xl">
                Join now, today!
              </span>
              <span className="px-32 md:p-0 text-2xl font-thin w-[36rem] self-center">
              ...
              <div className="absolute bottom-4 left-0 right-0 flex sm:justify-center sm:mt-0">
                <div className="flex max-w-fit gap-4 bg-black p-4 rounded-lg ">
